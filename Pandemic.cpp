...
void pandemic_management::admin()
{
    admin_password();
A:
    system("cls");
...
// ADMIN LOGIN
void pandemic_management::admin_password()
{
    system("cls");
    char a_name[20];
    char a_password[20];
    ...
    cout << "\n\n\t\tEnter Valid Captcha: ";
    cin >> capta;
    if ((strcmp(a_name, "Afaque") == 0) && (strcmp(a_password, "3919") == 0) && (capt == capta))
    {
        cout << "\n\n\n\t\t\t\t\t| Verfiying ADMIN |\n\t\t\t\t\t";
        for (int a = 1; a < 8; a++)
        {
...
void pandemic_management::valid(string str) // Check Username is available or not
{
    string dir, user;
    ifstream file;
    dir = str + ".txt";
...
void pandemic_management::user_password()
{
    system("cls");
    char c;
    int user_choice;
...
void pandemic_management::add_vaccine_stock()
{
A:
    fstream file;
    system("cls");
...
void pandemic_management::search_center()
{
    system("cls");
    ifstream file;
    cout << "\n\t\t\t\t*****************************************";
...
void pandemic_management::display_vaccine_stock()
{
    system("cls");
    ifstream ind;
    ...
    ind.seekg(0, ios::beg);
    while (ind.read((char *)this, sizeof(pandemic_management)))
        ;
    {
        i++;
    }
...
void pandemic_management::add_doctor()
{
    system("cls");
    cout << "\n\t\t\t\t*****************************************";
    cout << "\n\t\t\t\t   *    PANDEMIC MANAGEMENT SYSTEM    *";
...
B:
    ...
    file.write((char *)this, sizeof(pandemic_management));
...
void pandemic_management::display_doctor_data()
{
    system("cls");
    cout << "\n\t\t\t\t*****************************************";
    cout << "\n\t\t\t\t   *    PANDEMIC MANAGEMENT SYSTEM    *";
...
void pandemic_management::doctor_show_data()
{
...
void pandemic_management::search_doctor_data()
{
B:
    system("cls");
    int choice;
    ...
    case 1:
    {
        ...
        {
            file.read((char *)this, sizeof(pandemic_management));
        }
        while (!file.eof())
        {
...
void pandemic_management::applied_vaccine()
{
    ifstream ind;
    system("cls");
    cout << "\n\t\t\t\t*****************************************";
...
void pandemic_management::show_patient_data()
{
B:
    system("cls");
    int choice;
...
void pandemic_management::search_by_aadhar()
{
    int count = 0;
    string sadhaar;
    ifstream file;
...
void pandemic_management::search_by_age()
{
    int count = 0;
    int sage;
    ifstream file;
...
void pandemic_management::search_by_profession()
{
    int count = 0;
    string sprofession;
    ifstream file;
...
void pandemic_management::search_by_gender()
{
    int count = 0;
    char sgender[10];
    ifstream file;
...
void pandemic_management::add_patient_data()
{
    fstream file;
    system("cls");
    cout << "\n\t\t\t\t*****************************************";
...
void pandemic_management::patient_show_data()
{
    int count = 0;
    string vadhaar;
    ifstream file;
...
void pandemic_management::show_data()
{
    cout.setf(ios::left, ios::adjustfield);
    cout.width(20);
    cout << endl
...
void pandemic_management::update_patient_data()
{
    fstream file;
    system("cls");
    string maadhaar;
